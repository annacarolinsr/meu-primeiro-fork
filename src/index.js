...
var area = largura * altura; // Multiplicando largura e altura para achar a área
...
var mensagem = "Bem-vindo, " + nome + " " + sobrenome + "!";
...
var idadeEmDias = idadeEmAnos * 365; // Multiplica a idade por 365 dias
...
var horas = Math.floor(duracaoEmMinutos / 60); // Parte inteira da divisão vira horas
var minutos = duracaoEmMinutos % 60; // O resto vira os minutos
